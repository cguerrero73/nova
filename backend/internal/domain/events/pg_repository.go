...
func (r *pgEventRepository) FindByID(ctx context.Context, id string) (*Event, error) {
	query := `
...
func (r *pgEventRepository) FindByCode(ctx context.Context, code string) (*Event, error) {
	query := `
		SELECT evt_id, evt_code, evt_org, evt_desc, evt_type, evt_rtype, evt_status,
		       evt_rstatus, evt_object, evt_object_org, evt_notused, evt_tenant_id,
		       evt_created_at, evt_updated_at, evt_created_by, evt_updated_by
...
func (r *pgEventRepository) FindAll(ctx context.Context, tenantID string, org string, limit, offset int) ([]*Event, int, error) {
...
func (r *pgEventRepository) FindByOrg(ctx context.Context, org string) ([]*Event, error) {
	query := `
		SELECT evt_id, evt_code, evt_org, evt_desc, evt_type, evt_rtype, evt_status,
		       evt_rstatus, evt_object, evt_object_org, evt_notused, evt_tenant_id,
		       evt_created_at, evt_updated_at, evt_created_by, evt_updated_by
...
func (r *pgEventRepository) FindByObject(ctx context.Context, objectCode, objectOrg string) ([]*Event, error) {
	query := `
		SELECT evt_id, evt_code, evt_org, evt_desc, evt_type, evt_rtype, evt_status,
		       evt_rstatus, evt_object, evt_object_org, evt_notused, evt_tenant_id,
		       evt_created_at, evt_updated_at, evt_created_by, evt_updated_by
...
func (r *pgEventRepository) FindByType(ctx context.Context, typeCode string) ([]*Event, error) {
	query := `
		SELECT evt_id, evt_code, evt_org, evt_desc, evt_type, evt_rtype, evt_status,
		       evt_rstatus, evt_object, evt_object_org, evt_notused, evt_tenant_id,
		       evt_created_at, evt_updated_at, evt_created_by, evt_updated_by
...
func (r *pgEventRepository) FindByStatus(ctx context.Context, status string) ([]*Event, error) {
	query := `
		SELECT evt_id, evt_code, evt_org, evt_desc, evt_type, evt_rtype, evt_status,
		       evt_rstatus, evt_object, evt_object_org, evt_notused, evt_tenant_id,
		       evt_created_at, evt_updated_at, evt_created_by, evt_updated_by
...
func (r *pgEventRepository) Create(ctx context.Context, e *Event) error {
	query := `
...
func (r *pgEventRepository) Update(ctx context.Context, e *Event) error {
	query := `
		UPDATE eamevents 
