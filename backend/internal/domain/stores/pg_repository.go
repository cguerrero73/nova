...
func (r *pgStoreRepository) FindByID(ctx context.Context, id string) (*Store, error) {
	query := `
...
func (r *pgStoreRepository) FindByCode(ctx context.Context, code string) (*Store, error) {
	query := `
		SELECT str_id, str_code, str_name, str_desc, str_org, str_notused,
		       str_tenant_id, str_created_at, str_updated_at
...
func (r *pgStoreRepository) FindAll(ctx context.Context, tenantID string, org string) ([]*Store, error) {
	query := `
		SELECT str_id, str_code, str_name, str_desc, str_org, str_notused,
		       str_tenant_id, str_created_at, str_updated_at
...
func (r *pgStoreRepository) FindByOrg(ctx context.Context, org string) ([]*Store, error) {
	return r.FindAll(ctx, "", org)
}

func (r *pgStoreRepository) Create(ctx context.Context, s *Store) error {
	query := `
...
func (r *pgStoreRepository) Update(ctx context.Context, s *Store) error {
	query := `
		UPDATE eamstores 
...
func (r *pgBinRepository) FindByID(ctx context.Context, id string) (*Bin, error) {
	query := `
...
func (r *pgBinRepository) FindByCode(ctx context.Context, code, org string) (*Bin, error) {
	query := `
		SELECT bin_id, bin_code, bin_desc, bin_org, bin_notused,
		       bin_tenant_id, bin_created_at, bin_updated_at
...
func (r *pgBinRepository) FindAll(ctx context.Context, tenantID string, org string) ([]*Bin, error) {
	query := `
		SELECT bin_id, bin_code, bin_desc, bin_org, bin_notused,
		       bin_tenant_id, bin_created_at, bin_updated_at
...
func (r *pgBinRepository) FindByOrg(ctx context.Context, org string) ([]*Bin, error) {
	return r.FindAll(ctx, "", org)
}

func (r *pgBinRepository) Create(ctx context.Context, b *Bin) error {
	query := `
...
func (r *pgBinRepository) Update(ctx context.Context, b *Bin) error {
	query := `
		UPDATE eambins 
