import {
  ...
  stringToHeaders,
  toPublicUrl
} from "./chunk-NWKAGMYZ.js";
import {
  parse
} from "./chunk-BAJX5HDA.js";
import {
  __async,
  __objRest,
  __spreadProps,
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/internal/checkGlobals.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/internal/isStringEqual.mjs
function isStringEqual(actual, expected) {
  return actual.toLowerCase() === expected.toLowerCase();
}

// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/logging/getStatusCodeColor.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/logging/serializeRequest.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/logging/serializeResponse.mjs
var {
  message
} = statuses_default;
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/url/cleanUrl.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/url/isAbsoluteUrl.mjs
function isAbsoluteUrl(url) {
  return /^([a-z][a-z\d+\-.]*:)?\/\//i.test(url);
}

// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/url/getAbsoluteUrl.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/matching/normalizePath.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/matching/matchRequestUrl.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/shims/cookie.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/request/getRequestCookies.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/handlers/HttpHandler.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/http.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/internal/parseMultipartData.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/internal/parseGraphQLRequest.mjs
...
function parseQuery(query) {
  return __async(this, null, function* () {
    const {
      parse: parse4
    } = yield import("./graphql-LNG4SU22.js").catch((error) => {
    ...
    switch (request.method) {
      ...
      case "POST": {
        ...
        if (request.headers.get("content-type")?.includes("multipart/form-data")) {
          ...
          const _a = responseJson, {
            operations,
            map
          } = _a, files = __objRest(_a, [
            "operations",
            "map"
          ]);
...
function parseGraphQLRequest(request) {
  return __async(this, null, function* () {
    ...
    const parsedResult = yield parseQuery(query);
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/HttpResponse.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/request/getAllAcceptedMimeTypes.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/handlers/GraphQLHandler.mjs
...
var GraphQLHandler = class _GraphQLHandler extends RequestHandler {
  ...
  constructor(operationType, predicate, endpoint, resolver, options) {
    const operationName = _GraphQLHandler.#parseOperationName(predicate, operationType);
    ...
    super({
      info: {
        header,
        operationType,
        operationName: _GraphQLHandler.#parseOperationName(predicate, operationType)
      },
      resolver,
      options
    });
  ...
  parseGraphQLRequestOrGetFromCache(request) {
    return __async(this, null, function* () {
      if (!_GraphQLHandler.parsedRequestCache.has(request)) {
        _GraphQLHandler.parsedRequestCache.set(request, yield parseGraphQLRequest(request).catch((error) => {
          console.error(error);
          return void 0;
        }));
      }
  ...
  parse(args) {
    return __async(this, null, function* () {
      ...
      const parsedResult = yield this.parseGraphQLRequestOrGetFromCache(args.request);
...
Consider naming this operation or using "graphql.operation()" request handler to intercept GraphQL requests regardless of their operation name/type. Read more: https://mswjs.io/docs/api/graphql/#graphqloperationresolver`);
      ...
      const hasMatchingOperationName = yield this.matchOperationName({
        request: args.request,
  ...
  run(args) {
    return __async(this, null, function* () {
      const result = yield __superGet(_GraphQLHandler.prototype, this, "run").call(this, args);
      ...
      if (graphqlResponseIndex !== -1 && (jsonIndex === -1 || graphqlResponseIndex <= jsonIndex)) {
        result.response.headers.set("content-type", "application/graphql-response+json");
      }
      return result;
    });
  }
  matchOperationName(args) {
    return __async(this, null, function* () {
      if (typeof this.info.operationName === "function") {
        const customPredicateResult = yield this.info.operationName(__spreadValues({
          request: args.request
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/graphql.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/handlers/WebSocketHandler.mjs
...
var WebSocketHandler = class {
  ...
  parse(args) {
    ...
    const match2 = matchRequestUrl(clientUrl, resolvedHandlerUrl, args.resolutionContext?.baseUrl);
    return {
      match: match2
    };
  }
  ...
  run(connection, resolutionContext) {
    return __async(this, null, function* () {
      ...
      const resolvedConnection = __spreadProps(__spreadValues({}, connection), {
  ...
  #resolveWebSocketUrl(url, baseUrl) {
    const resolvedUrl = resolveWebSocketUrl(baseUrl ? (
      /**
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/utils/internal/hasRefCounted.mjs
function hasRefCounted(value) {
  return typeof Reflect.get(value, "ref") === "function" && typeof Reflect.get(value, "unref") === "function";
}

// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/ws/WebSocketMemoryClientStore.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/ws/WebSocketIndexedDBClientStore.mjs
...
var WebSocketIndexedDBClientStore = class {
  ...
  createDatabase() {
    return __async(this, null, function* () {
      ...
      request.onupgradeneeded = (_0) => __async(null, [_0], function* ({
        currentTarget
      }) {
        const db = Reflect.get(currentTarget, "result");
        if (db.objectStoreNames.contains(DB_STORE_NAME)) {
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/ws/WebSocketClientManager.mjs
var WebSocketClientManager = class {
  constructor(channel) {
    ...
    if (typeof window !== "undefined") {
      window.addEventListener("message", (message2) => __async(this, null, function* () {
        if (message2.data?.type === "msw/worker:stop") {
          yield this.removeRuntimeClients();
        }
      }));
    }
  }
  ...
  runtimeClients;
  allClients;
  flushDatabaseToMemory() {
    return __async(this, null, function* () {
      const storedClients = yield this.store.getAll();
  ...
  removeRuntimeClients() {
    return __async(this, null, function* () {
      yield this.store.deleteMany(Array.from(this.runtimeClients.keys()));
      this.runtimeClients.clear();
      yield this.flushDatabaseToMemory();
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/ws.mjs
...
function createWebSocketLinkHandler(url) {
  ...
  return {
    ...
    addEventListener(event, listener) {
      ...
      handler[kEmitter].on("connection", (_0) => __async(null, [_0], function* ({
        client
      }) {
        yield clientManager.addConnection(client);
      }));
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/delay.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/sse.mjs
...
var ServerSentEventHandler = class _ServerSentEventHandler extends HttpHandler {
  #emitter;
  constructor(path, resolver) {
    ...
    super("GET", path, (info) => __async(this, null, function* () {
      const stream = new ReadableStream({
        start: (controller) => __async(this, null, function* () {
          ...
          yield resolver(__spreadProps(__spreadValues({}, info), {
            client,
            server
          }));
        })
  ...
  predicate(args) {
    return __async(this, null, function* () {
      ...
      const matches = yield __superGet(_ServerSentEventHandler.prototype, this, "predicate").call(this, args);
      if (matches && !args.resolutionContext?.quiet) {
        yield __superGet(_ServerSentEventHandler.prototype, this, "log").call(this, {
          request: args.request,
          /**
...
var ObservableEventSource = class _ObservableEventSource extends EventTarget {
  ...
  connect() {
    return __async(this, null, function* () {
      yield fetch(this[kRequest]).then((response) => {
  ...
  interpretResponseBody(response) {
    const parsingStream = new EventSourceParsingStream({
      message: (message2) => {
        ...
        const messageEvent = new MessageEvent(message2.event ? message2.event : "message", {
          data: message2.data,
  ...
  reestablishConnection() {
    return __async(this, null, function* () {
      ...
      yield delay(this[kReconnectionTime]);
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/getResponse.mjs
var getResponse = (handlers, request, resolutionContext) => __async(null, null, function* () {
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/bypass.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/passthrough.mjs
...
// node_modules/.pnpm/msw@2.12.14_@types+node@22.19.15_typescript@5.8.3/node_modules/msw/lib/core/index.mjs
checkGlobals();
export {
  GraphQLHandler,
  HttpHandler,
