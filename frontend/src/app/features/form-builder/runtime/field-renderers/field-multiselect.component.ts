...
import { MultiselectField } from '../../models/layout-definition.model';
...
@Component({
  ...
  styles: [`
    ...
    .field-multiselect { padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem; font-size: 0.875rem; min-height: 5rem; }
    .field-multiselect:disabled { background-color: #f3f4f6; cursor: not-allowed; }
...
export class FieldMultiselectComponent {
  field = input.required<MultiselectField>();
